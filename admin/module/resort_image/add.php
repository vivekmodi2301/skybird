...
{
	$id=$_GET['id'];
	$data=mysql_fetch_array(mysql_query("select id,photo from resort_image where id=$id  "));
}
	if(isset($_POST['submit']))
	{
		...
		unlink("resort_img/".$_POST['photo']);
		$fn=time()."_".$_FILES['photo']['name'];
		move_uploaded_file($_FILES['photo']['tmp_name'],"resort_img/".$fn);
		
		$_POST['photo']=$fn;
		    }else{
		        echo "Please upload only jpeg or png file";
		    }
		}
		
		addedit('resort_image',$_POST,$id);
		?>
		<script>location.href="index.php?mod=resort_image&do=list";</script>
		<?php
	}
  ...
  <tr>
    <td><div id="hsnazzy"> <b class="htop"><b class="hb1"></b><b class="hb2"></b><b class="hb3"></b><b class="hb4"></b></b>
        <div class="hboxcontent">
          <table width="100%">
            <tr>
              <th align="left">&nbsp;Resort Photo Gallery </th>
            </tr>
          </table>
        </div>
